...
-- Then set: vim.cmd.colorscheme("snowy-pink") or use LazyVim's colorscheme option.
--
...
local derived = {
  ...
  bg_visual = "#2e002c", -- slightly lighter than bg, used for visual selection
  bg_search = "#1f001d", -- used for search highlight backgrounds
  bg_cursorline = "#380036", -- subtle cursorline
  fg_comment = "#924890", -- muted foreground for comments
}
