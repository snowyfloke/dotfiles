...
-- Then set: vim.cmd.colorscheme("snowy-cyan") or use LazyVim's colorscheme option.
--
...
local derived = {
  bg_dark = "#0f262c", -- darker than bg, used for sidebars/inactive areas
  bg_darker = "#0b1c21", -- even darker, used for floating window backgrounds
  bg_visual = "#184551", -- slightly lighter than bg, used for visual selection
  bg_search = "#0a4150", -- used for search highlight backgrounds
  bg_cursorline = "#1e4a55", -- subtle cursorline
  fg_comment = "#488392", -- muted foreground for comments
}
