...
-- Then set: vim.cmd.colorscheme("snowy-magenta") or use LazyVim's colorscheme option.
--
...
local derived = {
  bg_dark = "#0d0414", -- darker than bg, used for sidebars/inactive areas
  bg_darker = "#050108", -- even darker, used for floating window backgrounds
  bg_visual = "#260a3d", -- slightly lighter than bg, used for visual selection
  bg_search = "#1e0136", -- used for search highlight backgrounds
  bg_cursorline = "#2b0e42", -- subtle cursorline
  fg_comment = "#714892", -- muted foreground for comments
}
...
function M.setup()
  ...
  vim.g.colors_name = "snowy-magenta"
