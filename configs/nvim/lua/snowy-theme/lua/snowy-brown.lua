...
-- Then set: vim.cmd.colorscheme("snowy-brown") or use LazyVim's colorscheme option.
--
...
local derived = {
  ...
  bg_visual = "#201400", -- slightly lighter than bg, used for visual selection
  bg_search = "#110b00", -- used for search highlight backgrounds
  bg_cursorline = "#2a1b00", -- subtle cursorline
  fg_comment = "#927848", -- muted foreground for comments
}
