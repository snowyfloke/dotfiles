...
-- Then set: vim.cmd.colorscheme("snowy-blue") or use LazyVim's colorscheme option.
--
...
local derived = {
  bg_dark = "#020512", -- darker than bg, used for sidebars/inactive areas
  bg_darker = "#000104", -- even darker, used for floating window backgrounds
  bg_visual = "#040f3e", -- slightly lighter than bg, used for visual selection
  bg_search = "#000933", -- used for search highlight backgrounds
  bg_cursorline = "#071345", -- subtle cursorline
  fg_comment = "#485692", -- muted foreground for comments
}
