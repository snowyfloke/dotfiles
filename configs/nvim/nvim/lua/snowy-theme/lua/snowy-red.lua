...
-- Then set: vim.cmd.colorscheme("snowy-red") or use LazyVim's colorscheme option.
--
...
local derived = {
  ...
  bg_visual = "#290000", -- slightly lighter than bg, used for visual selection
  bg_search = "#1a0000", -- used for search highlight backgrounds
  bg_cursorline = "#330000", -- subtle cursorline
  fg_comment = "#924848", -- muted foreground for comments
}
