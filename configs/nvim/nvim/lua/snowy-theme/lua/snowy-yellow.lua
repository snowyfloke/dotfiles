...
-- Then set: vim.cmd.colorscheme("snowy-yellow") or use LazyVim's colorscheme option.
--
...
local derived = {
  ...
  bg_visual = "#291f00", -- slightly lighter than bg, used for visual selection
  bg_search = "#1a1400", -- used for search highlight backgrounds
  bg_cursorline = "#332700", -- subtle cursorline
  fg_comment = "#928148", -- muted foreground for comments
}
...
function M.setup()
  ...
  vim.g.colors_name = "snowy-yellow"
