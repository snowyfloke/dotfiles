...
-- Then set: vim.cmd.colorscheme("snowy-orange") or use LazyVim's colorscheme option.
--
...
local derived = {
  ...
  bg_visual = "#2e1400", -- slightly lighter than bg, used for visual selection
  bg_search = "#1f0e00", -- used for search highlight backgrounds
  bg_cursorline = "#381900", -- subtle cursorline
  fg_comment = "#926a48", -- muted foreground for comments
}
...
function M.setup()
  ...
  vim.g.colors_name = "snowy-orange"
