...
-- Then set: vim.cmd.colorscheme("snowy-lime") or use LazyVim's colorscheme option.
--
...
local derived = {
  ...
  bg_visual = "#132e00", -- slightly lighter than bg, used for visual selection
  bg_search = "#0d1f00", -- used for search highlight backgrounds
  bg_cursorline = "#173800", -- subtle cursorline
  fg_comment = "#679248", -- muted foreground for comments
}
