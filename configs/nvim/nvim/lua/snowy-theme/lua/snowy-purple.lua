...
-- Then set: vim.cmd.colorscheme("snowy-purple") or use LazyVim's colorscheme option.
--
...
local derived = {
  bg_dark = "#000001", -- darker than bg, used for sidebars/inactive areas
  bg_darker = "#000000", -- even darker, used for floating window backgrounds
  bg_visual = "#13002f", -- slightly lighter than bg, used for visual selection
  bg_search = "#0c0020", -- used for search highlight backgrounds
  bg_cursorline = "#170039", -- subtle cursorline
  fg_comment = "#664892", -- muted foreground for comments
}
...
function M.setup()
  ...
  vim.g.colors_name = "snowy-purple"
